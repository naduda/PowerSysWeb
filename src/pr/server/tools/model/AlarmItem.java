...
public class AlarmItem {
	...
	public AlarmItem(Alarm a) {
		...
		recordDT = a.getRecorddt() != null ? dFormat.format(a.getRecorddt()) : "";
		eventDT = a.getEventdt() != null ? dFormat.format(a.getEventdt()) : "";
		...
		confirmDT = a.getConfirmdt() != null ? dFormat.format(a.getConfirmdt()) : "";
